...
//credit goes to Steven Frank of Cloud to Butt for handleText Function
...
function handleText(textNode) {
    ...
    function replacer(match, p1, offset, string) {
        ...
        var rounded_numerals = Math.round((numerals / 4) * 100) / 100; // divide by 6.25 and round to 2 decimal places
